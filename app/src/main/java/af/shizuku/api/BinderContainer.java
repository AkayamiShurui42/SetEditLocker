...
/**
 * Parcelable shape used by the native Shizuku+ provider when delivering its binder.
 * Kept locally so SetEditLocker can receive the Plus binder without depending on the
 * unpublished ShizukuPlus-API artifact.
 */
